function loadTablePage(table, page, size, baseUrl, filter) {
    ...
    $.ajax(baseUrl + '?page=' + page + '&size=' + size, {
        ...
        success: function(data, status, xhr) {
            ...
            data.elements.forEach(function(item, index) {
                ...
                var rowAppend = "<tr><td>"+fechaHora+"</td><td>"+productoNombre+"</td><td>"
                +productoSku+"</td><td>"+entradaCantidad+"</td><td>"+entradaValorUnitario
                +"</td><td>"+entradaValorTotal+"</td><td>"+saldoCantidad+"</td><td>"
                +saldoValorUnitario+"</td><td>"+saldoValorTotal+"</td><td>"+saldoCantidad
                +"</td><td>"+saldoValorUnitario+"</td><td>"+saldoCantidad+"</td></tr>";
...
function setupTable(table, size, baseUrl, filter) {
